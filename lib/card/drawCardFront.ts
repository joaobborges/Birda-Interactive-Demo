...
export async function drawCardFront(
  ...
  ctx.textAlign = "center"
  ctx.textBaseline = "middle"
  ctx.fillText("Common Kingfisher", 250, 465)
  ctx.restore()
  ...
  ctx.textAlign = "center"
  ctx.textBaseline = "middle"
  ctx.fillText("Alcedo atthis", 250, 492)
  ctx.restore()
  ...
  ctx.textAlign = "center"
  ctx.textBaseline = "middle"
  ctx.fillText("Alcedinidae", 250, 535)
  ctx.fillText("Rivers, Lakes & Streams", 250, 558)
  ctx.fillText("Least Concern", 250, 581)
  ctx.restore()

  // --- 8.5. Birda logo mark (below species info, above grain) ---
