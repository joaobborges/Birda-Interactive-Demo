    ...
    <section className="bg-cream min-h-screen flex flex-col items-center justify-start px-6 pt-16 pb-24">
      ...
      <AnimatedWrapper className="mt-20 max-w-2xl text-center">
        <p className="font-sans text-lg md:text-xl text-near-black/80 leading-relaxed">
          This is a concept for a new way to reward your most engaged users
          and keep them coming back. Field Cards are collectible assets tied to
          real activity. Users join challenges, and the top ten earn a physical
          card shipped to their door. The top hundred unlock a digital card
          they keep forever in the app. No purchases, no shortcuts. Every card
          is earned, and every card means something.
        </p>
      </AnimatedWrapper>
